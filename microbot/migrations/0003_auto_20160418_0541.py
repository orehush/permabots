    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='microbot.KikChat', verbose_name='Chat')),
            ],
            options={
                'ordering': ['-timestamp'],
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(default=None, help_text='Telegram unique username', on_delete=django.db.models.deletion.CASCADE, related_name='telegram_chatstates', to='microbot.User', verbose_name='Telegram User'),
        ...
        migrations.AlterField(
            model_name='telegramchatstate',
            name='chat',
            field=models.ForeignKey(help_text='Chat in Telegram API format. https://core.telegram.org/bots/api#chat', on_delete=django.db.models.deletion.CASCADE, related_name='telegram_chatstates', to='microbot.Chat', verbose_name='Chat'),
        ),
        migrations.AlterField(
            model_name='telegramchatstate',
            name='state',
            field=models.ForeignKey(help_text='State related to the chat', on_delete=django.db.models.deletion.CASCADE, related_name='telegramchatstate_chat', to='microbot.State', verbose_name='State'),
        ),
        migrations.AlterField(
        ...
        migrations.AddField(
            ...
            name='hook',
            field=models.ForeignKey(help_text='Hook which recipient is attached to', on_delete=django.db.models.deletion.CASCADE, related_name='kik_recipients', to='microbot.Hook', verbose_name='Hook'),
        ),
        migrations.AddField(
            model_name='kikmessage',
            name='from_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='microbot.KikUser', verbose_name='User'),
        ),
        migrations.AddField(
            model_name='kikchatstate',
            name='state',
            field=models.ForeignKey(help_text='State related to the chat', on_delete=django.db.models.deletion.CASCADE, related_name='kikchatstate_chat', to='microbot.State', verbose_name='State'),
        ),
        migrations.AddField(
            model_name='kikchatstate',
            name='user',
            field=models.ForeignKey(help_text='Kik unique username', on_delete=django.db.models.deletion.CASCADE, related_name='kik_chatstates', to='microbot.KikUser', verbose_name='Kik User'),
        ),
        migrations.AddField(
            model_name='kikchat',
            name='participants',
            field=models.ManyToManyField(blank=True, related_name='chats', to='microbot.KikUser', verbose_name='Participants'),
        ),
        migrations.AddField(
            model_name='bot',
            name='kik_bot',
            field=models.OneToOneField(blank=True, help_text='Kik Bot', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bot', to='microbot.KikBot', verbose_name='Kik Bot'),
        ),
        migrations.AddField(
            model_name='bot',
            name='owner',
